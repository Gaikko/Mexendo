...
--
-- Host: 127.0.0.1
-- Tempo de geração: 31-Maio-2022 às 16:47
...
(0, '2022-06-04', '2022-07-09', 2450),
(1, '2022-05-26', '2022-05-26', 1),
(2, '2022-05-31', '2022-06-30', 1500),
(3, '2022-05-20', '2022-07-31', 5000);
...
(1, '00000000003', 1, NULL, NULL),
(2, '00000000002', 1, NULL, NULL);
...
ALTER TABLE `senacoin`
  ADD PRIMARY KEY (`id_senacoin`) USING BTREE;
